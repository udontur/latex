...
\begin{document}
		...
		\begin{tikzpicture}
			\begin{axis} [
				...
				\addplot[
					...
					(0,0)(0.03,-0.33)(0.06,-0.67)(0.09,-1)(0.12,-1.33)(0.15,-1.67)(0.17,-1.67)
				};
			\end{axis}
		\end{tikzpicture}
	\end{center}
	...
	\subsection{Error sources}
	The position-time graph has similar curves and values as the theoretical graph. 
	
	The velocity-time graph also has similar slope and values as the theoretical graph, but at the last data point, the velocity does not match the linear progression because of errors during measurement. It is very hard to accurrately measure where and when the steel ball lands because there is a plastic plate covering the last bit of the graph. 
